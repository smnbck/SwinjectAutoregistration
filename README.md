...
```
github "Swinject/Swinject" "2.8.2"
github "Swinject/SwinjectAutoregistration" "2.8.2"
```
...
pod 'Swinject', '2.8.2'
pod 'SwinjectAutoregistration', '2.8.2'
```
...
```swift
dependencies: [
    .package(url: "https://github.com/Swinject/SwinjectAutoregistration.git", from: "2.8.2")
],
targets: [
    .target(
        name: "MyProject",
